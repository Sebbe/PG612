...
Model::Model(std::string filename, bool invert) {
	...
	root.transform = glm::scale(glm::mat4(1), glm::vec3(6.44f));
	root.transform = glm::translate(root.transform, glm::vec3(0.016800813, -0.11015295, 0.0014822669));

// 	root.transform = glm::scale(glm::mat4(1), glm::vec3(0.1f));
// 	root.transform = glm::translate(root.transform, glm::vec3(0.016800813, -0.11015295, -0.2));
